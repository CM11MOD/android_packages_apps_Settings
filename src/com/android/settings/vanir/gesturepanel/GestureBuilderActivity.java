...
package com.android.settings.vanir.gesturepanel;
...
public class GestureBuilderActivity extends ListActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gesture_gestures_list);
    ...
    private class GesturesAdapter extends ArrayAdapter<NamedGesture> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.gesture_gestures_item, parent, false);
            }
