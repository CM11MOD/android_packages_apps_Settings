...
public class BatterySaverSettings extends SettingsPreferenceFragment implements
    ...
    private SeekBarPreference2 mInitialBrightness;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatterySaverDelay = (SeekBarPreference2) prefSet.findPreference(PREF_KEY_BATTERY_SAVER_MODE_CHANGE_DELAY);
        ...
        mLowBatteryLevel = (SeekBarPreference2) prefSet.findPreference(PREF_KEY_BATTERY_SAVER_MODE_BATTERY_LEVEL);
        ...
        mInitialBrightness = (SeekBarPreference2) prefSet.findPreference(PREF_KEY_BATTERY_SAVER_MODE_BRIGHTNESS_LEVEL);
